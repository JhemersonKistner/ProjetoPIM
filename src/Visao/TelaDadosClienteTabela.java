 ...
 * @author Jhemerson
 */
public class TelaDadosClienteTabela extends javax.swing.JFrame {

    /**
     * Creates new form TelaDadosClienteTabela
     */
    public TelaDadosClienteTabela() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDadosClienteTabela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDadosClienteTabela().setVisible(true);
            }
        });
    }
